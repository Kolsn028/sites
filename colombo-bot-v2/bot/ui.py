...
def vacation_panel_embed():
    return panel('ВРЕМЯ НА ОТДЫХ', 'Нужна пауза? Предупреди руководство — сохрани порядок в составе.', [
        ...
        ('03  /  ВОЗВРАЩАЙСЯ В СТРОЙ', 'Добавляется только роль Отдых. Остальные роли сохраняются. Для возврата нажми «Вернуться из отпуска»: причина и комментарий, затем одобрение High и выше.'),
    ], 0xC69B59)
