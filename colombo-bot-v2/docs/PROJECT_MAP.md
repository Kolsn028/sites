...
| Заявки в семью, рекрутеры | bot/forms/applications.py, bot/recruiting.py, bot/enhancements.py | test_recruiting.py, test_enhancements.py |
| Отдых и возвращение | bot/leave.py, bot/forms/vacations.py | test_leave_role_only.py |
